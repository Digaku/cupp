...
# Birthdays first
	...
	if randnum == "y":
        ...
        _komb22 = []
        for w in word:
            for kaak in kombinaak:
                _komb22.append(kaak + w)
        komb22.extend(_komb22)
        komb22.extend(humanize(_komb22))
        print "komb22:", komb22
